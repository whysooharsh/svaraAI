...
export default function Messages() {
  ...
  return (
    <motion.div
      layoutScroll
      className="relative grow overflow-auto p-6 pt-24"
      ref={scrollRef}
    >
              ...
              if (msg.type === "user_message" || msg.type === "assistant_message") {
                ...
                return (
                  <motion.div
                    ...
                    className={cn(
                      "w-[75%] max-w-lg backdrop-blur-xl border border-white/40 rounded-2xl shadow-lg overflow-hidden",
                      isUser
                  ...
                  >
                    ...
                    {msg.models.prosody?.scores && (
                      <div className="border-t border-white/30 bg-gradient-to-r from-white/20 to-white/10">
